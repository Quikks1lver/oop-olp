...
//                    System.out.printf("~~~~~~~~~~~~~~~~ Got em. Yours: %d, winning: %d, won: %f\n", playerNumbers.get(j), winningNumbers.get(i), prizes.get(j));
        ...
        {
//            System.out.printf("\t%c v. %c\n", bonus.get(i).charValue(), winningBonus);
...
//                System.out.printf("~~~~~~~~~~~~~~~~ bonus. Yours: %c, winning: %c, won: %f\n", bonus.get(i).charValue(), winningBonus, BONUS);
        ...
        System.out.println("Your Ten Dollar Scratch Off won you $" + cash);
    ...
    private void displayTicket()
    {
        ...
        printStartEndLine();
        System.out.printf("| WINNING NUMBER %5d %5d %5d %5d   |\n", this.winningNumbers.get(0), this.winningNumbers.get(1), this.winningNumbers.get(2), this.winningNumbers.get(3));
        printPipeLine();
        ...
        printPipeLine();
        System.out.printf("|\t%c\t%c\t%c\t%c          |\n", this.bonus.get(0), this.bonus.get(1), this.bonus.get(2), this.bonus.get(3));
